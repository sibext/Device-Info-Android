...
public class MainActivity extends Activity {
    ...
    private void setScreenInfo() {
        ...
        String value = String.valueOf(density);
        if (density == DisplayMetrics.DENSITY_HIGH) {
            sb.append("HIGH: Density is ").append(value);
        } else if (density == DisplayMetrics.DENSITY_MEDIUM) {
            sb.append("MEDIUM: Density is ").append(value);
        } else if (density == DisplayMetrics.DENSITY_LOW) {
            sb.append("LOW: Density is ").append(value);
        } else if (density == DisplayMetrics.DENSITY_XHIGH|| density == DisplayMetrics.DENSITY_280) {
            sb.append("Extra HIGHT: Density is ").append(value);
        } else if (density == DisplayMetrics.DENSITY_XXHIGH || density == DisplayMetrics.DENSITY_400) {
            sb.append("Double Extra HIGHT: Density is ").append(value);
        } else if (density == DisplayMetrics.DENSITY_XXXHIGH || density == DisplayMetrics.DENSITY_560) {
            sb.append("Triplex Extra HIGHT: Density is ").append(value);
        } else if (density == DisplayMetrics.DENSITY_TV) {
            sb.append("TELEVISION: Density is ").append(value);
        } else {
        ...
        TextView val = (TextView) frameScreen.findViewById(R.id.item_value);
